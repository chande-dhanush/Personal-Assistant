...
def watch_anime(user_input):
    ...
    if '/anime' in user_input:
        ...
        if 'watch the anime' in user_input:
            user_input = user_input.replace('watch the anime', '').strip()
...
def handle_fun_apis(user_input):
    ...
    if '/advice' in user_input or 'some advice' in user_input:
        try:
...
def handle_command(user_input, chat_callback, assistant_ref=None):
    ...
    commands = {
        ...
        'play the video': lambda: handle_youtube_play_command(user_input_lower),
        ...
        '/advice': lambda: handle_fun_apis(user_input_lower),
