...
class SakuraChatWindow(QtWidgets.QWidget):
    ...
    def handle_input(self):
        ...
        command_keywords = [
            ...
            'joke', 'who is', 'system status', 'the time', 'the date', 'open', 'add contact',
            'spotify', 'watch anime', 'watch the anime', 'the weather', 'quote', 'advice',
            ' I am bored', ' search for ', 'search up', 'open mail', 'open Gmail'
        ]
