...
class SakuraChatWindow(QtWidgets.QWidget):
    ...
    def handle_input(self):
        ...
        command_keywords = [
            'play the song', 'play the video', 'send message to', 'whatsapp',
            'joke', 'who is', 'status', 'time', 'date', 'open', 'add contact',
            'spotify', 'watch anime', 'watch the anime', 'weather', 'quote', 'advice',
            'bored', 'search'
        ]
        ...
        try:
            with sr.Microphone() as source:
                ...
                try:
                    ...
                    # === Tool Command Check ===
                    command_keywords = [
                        'play the song', 'play the video', 'send message to', 'whatsapp', 'joke',
                        'who is', 'status', 'time', 'date', 'open', 'add contact',
                        'spotify', 'anime', 'watch the anime', 'weather', 'quote', 'advice',
                        'bored', 'search'
                    ]
